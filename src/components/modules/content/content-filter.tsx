...
export const ContentFilter = () => {
  ...
  const currentBlocked: StatusOption = blockedParam === 'true' ? 'hidden' : blockedParam === 'false' ? 'visible' : null;
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-auto md:w-65 p-4 space-y-4">
        <div className="space-y-2">
          <Label className="text-xs text-muted-foreground">Estado del contenido</Label>
